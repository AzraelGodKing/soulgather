...
- Quiet Court (v1.2 / v1.8) — Tribute starts Autobind Shades ON, and Autobind Lanterns ON (row still at 8 lanterns). Cost `8 × 2^n` Favor. Button: Seat the Court.
...
**Rites (this-run).** Hidden until the first Shade this run, or if The Well Draws is already on from Edict of Echoes. Forgotten on Tribute and on Footer Reset. ×1 buy only. Autobind Lanterns and Thin the Veil live here (v1.6). Autobind Fetters lives here (v1.8).
