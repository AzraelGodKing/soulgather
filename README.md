...
**v6.9.1.** Ash rites geometric costs (AZR-162); hidden-tab credit via `simulatedUntil` (AZR-163). Live: https://azraelgodking.github.io/soulgather/. Footer/CSS v6.9.1. Save key `soulgather-v0`.
...
Visual direction stays locked. Footer/CSS **v6.9.1** (bug-fix wave: AZR-162 ash-rite geo costs; AZR-163 simulatedUntil settle). Save key stays `soulgather-v0`.
