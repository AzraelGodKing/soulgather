...
Hotkeys: Space/Enter draw, 1/2/3 buy mode, T Tithe, N Night's Tithe, V Thin the Veil, C Cut the Cinders, B Lay the Bone, W Keep the Wake (not while typing in Memory; do not steal if another button is focused).
...
**Hotkeys.** T pays the Tithe if affordable. N pays Night's Tithe if available. V pays Thin the Veil if available. C pays Cut the Cinders if unlocked and Ash >= 15. B pays Lay the Bone if Remembrance is unlocked, ossuaryLevel < 8, and remembrance >= 1. None fire while typing in Memory. None steal if a button that is not Draw from the Well is focused.
