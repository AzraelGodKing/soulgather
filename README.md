...
**v6.9.1.** Ash rites geometric costs (AZR-162) — flat ash costs → `N.cost(base, 2.6, n)`. Live: https://azraelgodking.github.io/soulgather/. Footer/CSS v6.9.1. Save key `soulgather-v0`.
...
Visual direction stays locked. Footer/CSS **v6.9.1** (bug-fix wave: AZR-162 ash-rite geo costs). Save key stays `soulgather-v0`.
